...
public interface CacheService {
     ...
     * @return User
     */
    UserDO getUser(String username) throws Exception;
     ...
     * @return 角色集
     */
    List<RoleDO> getRoles(String username) throws Exception;
     ...
     * @return 权限集
     */
    List<PermissionDO> getPermissions(String username) throws Exception;
     ...
     * @param user 用户信息
     */
    void saveUser(UserDO user) throws Exception;
     ...
     * @param userType 用户类型
     */
    void saveUser(String username,String userType) throws Exception;
